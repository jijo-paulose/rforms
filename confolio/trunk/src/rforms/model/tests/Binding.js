...
doh.register("Binding-creation", [
  { name: "GroupBinding creation",
	setUp: setup,
	runTest: function() {
		var b1 = new rforms.model.GroupBinding(this.t1.getRoot());
  ...
  { name: "ValueBinding creation",
	setUp: setup,
	runTest: function() {
		var b1 = new rforms.model.ValueBinding(this.t1.getRoot().getChildren()[1]);
...
var setup2 = function() {
	...
	this.is = new rforms.template.ItemStore();
	this.t1 = this.is.createTemplate(rforms.template.tests.template1);
	this.b1 = new rforms.model.GroupBinding(this.t1.getRoot());
	this.b2 = new rforms.model.ValueBinding(this.t1.getRoot().getChildren()[1], this.s2);	
};
...
var setup4 = function() {
	...
	this.t1 = this.is.createTemplate(rforms.template.tests.template1);	
	this.b1 = new rforms.model.GroupBinding(this.t1.getRoot());
	this.b2 = new rforms.model.GroupBinding(this.t1.getRoot().getChildren()[0], this.s1, [this.s2]);
	this.b3 = new rforms.model.ValueBinding(this.t1.getRoot().getChildren()[0].getChildren()[0], this.s3);
	this.b4 = new rforms.model.ValueBinding(this.t1.getRoot().getChildren()[1], this.s4);
	this.b1.addChildBinding(this.b2);
...
var setup6 = function() {
	...
	this.t1 = this.is.createTemplate(rforms.template.tests.template1);	
	this.b1 = new rforms.model.GroupBinding(this.t1.getRoot());
	this.b2 = new rforms.model.PropertyGroupBinding(this.t1.getRoot().getChildren()[4], this.s1, [this.s2]);
	this.b3 = new rforms.model.ValueBinding(this.t1.getRoot().getChildren()[4].getChildren()[1].getChildren()[0], this.s3);
	this.b4 = new rforms.model.ValueBinding(this.t1.getRoot().getChildren()[1], this.s4);
	this.b1.addChildBinding(this.b2);
...
doh.register("Binding-assertions", [
  ...
  { name: "Checking two children validity in hierarchy",
	...
	runTest: function() {
		...
		this.b5 = new rforms.model.ValueBinding(this.t1.getRoot().getChildren()[0].getChildren()[1], this.s5);
