...
doh.register("Search-Graph", [
  ...
  function find_PO() {
  	var g = new rdfjson.Graph(rdfjson.tests.graph1);
	var r = g.find(undefined,"http://purl.org/dc/elements/1.1/related", { "value" : "http://example.org/about", "type" : "uri" });
	doh.t(r.length === 1);
	doh.t(r[0] instanceof rdfjson.Statement);  	
  },
  function findSPO() {
  	var g = new rdfjson.Graph(rdfjson.tests.graph1);
	var r = g.find("http://example.org/about", "http://purl.org/dc/elements/1.1/related", { "value" : "http://example.org/about", "type" : "uri" });
	doh.t(r.length === 1);
	doh.t(r[0] instanceof rdfjson.Statement);  	
  }
]);